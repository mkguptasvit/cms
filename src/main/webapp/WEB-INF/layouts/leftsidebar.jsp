...
<ul class="sidebar-menu">
	...
	<li class="treeview active"><a href="#"> <i
			class="fa fa-files-o"></i> <span>Users</span> <i class="fa fa-angle-left pull-right"></i>
	</a>
		<ul class="treeview-menu">
			<li><a href="<c:url value="/admin/allUsers"/>"><i class="fa fa-users"></i>All Users</a></li>
			<li class="active"><a href="<c:url value="/admin/addUser"/>"><i class="fa fa-user-plus"></i>Add New</a></li>
			<li><a href="#"><i class="fa fa-user"></i>Edit</a></li>			
		</ul></li>
	...
	<li class="treeview"><a href="#"> <i class="fa fa-folder"></i>
		...
		<ul class="treeview-menu">
			...
			<li><a href="../examples/404.html"><i class="fa fa-circle-o"></i>
					404 Error</a></li>
			<li><a href="../examples/500.html"><i class="fa fa-circle-o"></i>
					500 Error</a></li>
